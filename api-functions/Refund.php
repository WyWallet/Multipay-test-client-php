      ...
      <table>
          ...
          <td>
            <table>
              ...
              <tr>
                ...
                <td>
                  <input type="text" size="38" name="uxDescription" value="<?php print isset($_GET["uxDescription"]) ? $_GET["uxDescription"] : 'WW_TEST_REFUND' . date("Y-m-d_H:i:s");?>">
                </td>
              </tr>
              <tr>
        ...
        <tr>
          ...
          <td colspan="2" align="right">
            <input type="submit" name="uxBtnRefund" value="Refund">
          </td>
        </tr>
      </table>
    </form>
