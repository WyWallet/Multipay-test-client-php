...
if (isset($_GET["uxBtnCheck"]) && $_GET["uxBtnCheck"] != "") {
  $refundId = $_GET["uxRefundId"];
  
  $client = new Client();
  $responseObject = $client->getTransaction($refundId, $environment, $secretKey);
          ...
          <td style="width:235px">
            <table>
              <tr>
                ...
                <td>
                  <input type="text" size="12" name="uxRefundId" value="<?php print isset($_GET["uxRefundId"]) ? $_GET["uxRefundId"] : '';?>">
                </td>
              </tr>
            </table>
          </td>
