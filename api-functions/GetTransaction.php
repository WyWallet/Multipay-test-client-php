...
if (isset($_GET["uxBtnCheck"]) && $_GET["uxBtnCheck"] != "") {
  ...
  $client = new Client();
  $responseObject = $client->getTransaction($transactionId, $environment, $secretKey);
          ...
          <td style="width:235px">
            <table>
              <tr>
                ...
                <td>
                  <input type="text" size="12" name="uxTransactionId" value="<?php print isset($_GET["uxTransactionId"]) ? $_GET["uxTransactionId"] : '';?>">
                </td>
              </tr>
            </table>
          </td>
